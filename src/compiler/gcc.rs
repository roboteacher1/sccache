...
counted_array!(pub static ARGS: [ArgInfo<ArgData>; _] = [
    ...
    take_arg!("-fdebug-prefix-map", OsString, Concatenated('='), PreprocessorArgument),
    take_arg!("-fdiagnostics-color", OsString, Concatenated('='), DiagnosticsColor),
    take_arg!("-ffile-prefix-map", OsString, Concatenated('='), PreprocessorArgument),
    take_arg!("-fmacro-prefix-map", OsString, Concatenated('='), PreprocessorArgument),
